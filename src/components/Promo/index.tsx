...
export default function Promo() {
  return (
    ...
    <div className={styles['promo__team__description']}>
        ...
        <div className={styles['promo__team__table-item']}>Alex</div>
    <div className={styles['promo__team__table-item']}>Sofia</div>
    <div className={styles['promo__team__table-item']}>Designer</div>
    <div className={styles['promo__team__table-item']}>Market</div>
    </div>
        </div>
    </div>
  )
